...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_VIEWS_LIST), REQUEST(ACTION_TYPES.FETCH_VIEWS)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true,
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.CREATE_VIEWS), REQUEST(ACTION_TYPES.UPDATE_VIEWS), REQUEST(ACTION_TYPES.DELETE_VIEWS)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
  ...
  describe('Failures', () => {
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          FAILURE(ACTION_TYPES.FETCH_VIEWS_LIST),
          FAILURE(ACTION_TYPES.FETCH_VIEWS),
          FAILURE(ACTION_TYPES.CREATE_VIEWS),
          FAILURE(ACTION_TYPES.UPDATE_VIEWS),
          FAILURE(ACTION_TYPES.DELETE_VIEWS),
        ],
        'error message',
        state => {
          expect(state).toMatchObject({
  ...
  describe('Successes', () => {
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_VIEWS),
          payload,
        })
      ).toEqual({
        ...initialState,
    ...
    it('should create/update entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.CREATE_VIEWS),
          payload,
        })
      ).toEqual({
        ...initialState,
    ...
    it('should delete entity', () => {
      ...
      const toTest = reducer(undefined, {
        type: SUCCESS(ACTION_TYPES.DELETE_VIEWS),
        payload,
      });
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_VIEWS_LIST actions', async () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_VIEWS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_VIEWS),
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_VIEWS),
          payload: resolvedObject,
    ...
    it('dispatches ACTION_TYPES.CREATE_VIEWS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.CREATE_VIEWS),
        },
        {
          type: SUCCESS(ACTION_TYPES.CREATE_VIEWS),
          payload: resolvedObject,
    ...
    it('dispatches ACTION_TYPES.UPDATE_VIEWS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.UPDATE_VIEWS),
        },
        {
    ...
    it('dispatches ACTION_TYPES.DELETE_VIEWS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.DELETE_VIEWS),
        },
        {
          type: SUCCESS(ACTION_TYPES.DELETE_VIEWS),
          payload: resolvedObject,
