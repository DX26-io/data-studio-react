...
export const ACTION_TYPES = {
  ...
  FETCH_USERS: 'connections/FETCH_USERS',
  FETCH_USER: 'connections/FETCH_USER',
  CREATE_USER: 'connections/CREATE_USER',
  UPDATE_USER: 'connections/UPDATE_USER',
  DELETE_USER: 'connections/DELETE_USER',
