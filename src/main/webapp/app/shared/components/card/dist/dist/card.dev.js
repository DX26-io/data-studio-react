...
var Cards = function Cards(props) {
  return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(react_spectrum_1.View, {
    borderWidth: "thin",
    borderColor: "default",
    width: "size-3600",
    ...
    zIndex: 1000
  }, react_1["default"].createElement(card_thumbnail_1["default"], {
